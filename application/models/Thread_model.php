...
class Thread_model extends CI_Model
{
	...
	function detail($id) {
		return $this->db->select('users.username, users.photo, threads.created_at date_realease, threads.*')->join('users', 'users.id = threads.user_id')->where('threads.id', $id)->get('threads')->row();
	}
